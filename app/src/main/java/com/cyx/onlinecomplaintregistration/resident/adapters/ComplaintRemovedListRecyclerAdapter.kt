...
import com.cyx.onlinecomplaintregistration.resident.activities.home.ComplaintPostNoButtonActivity
...
class ComplaintRemovedListRecyclerAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            for (i in complaint.indices){
                loadLocation(itemView.context, complaint[i].complaint_latitude, complaint[i].complaint_longitude)
            }
            ...
            textViewMore.setOnClickListener {
                ...
                val intent = Intent(itemView.context, ComplaintPostNoButtonActivity::class.java)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.complaint_removed_recycler_view, parent, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textImportant.visibility = if (complaint[position].complaint_priority == 1) View.VISIBLE else View.GONE
        holder.textUrgent.visibility = if (complaint[position].complaint_priority == 2) View.VISIBLE else View.GONE
