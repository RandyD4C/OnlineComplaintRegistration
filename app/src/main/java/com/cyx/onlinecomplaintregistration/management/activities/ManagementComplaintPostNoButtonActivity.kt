...
class ManagementComplaintPostNoButtonActivity : AppCompatActivity() {
        ...
        reference.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(data: DataSnapshot) {
                ...
                if (data.exists()) {
                    for (i in data.children){
                        for (snapshot in i.children){
                            if (
                                ...
                                snapshot.child("complaint_status").value.toString() == "Done"
                            ){
                    ...
                    val builder = AlertDialog.Builder(this@ManagementComplaintPostNoButtonActivity)
